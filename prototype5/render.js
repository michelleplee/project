...
//boxGeometry = BoxGeometry(width,height,depth);
    ...
    var boxMaterial = new THREE.MeshPhongMaterial ( { color: 0x2194ce, shininess: 50});
        ...
        box4 = new THREE.Mesh( boxGeometry, boxMaterial);
        ...
        scene.add(box4);
         ...
         box5 = new THREE.Mesh( boxGeometry, boxMaterial);
        box5.position.x = 10;
        box5.position.y = 20;
        box5.position.z = 12;  
        scene.add(box5);
        ...
        box6 = new THREE.Mesh( boxGeometry, boxMaterial);
        box6.position.x = 22;
        box6.position.y = 20;
        box6.position.z = 12;
        scene.add(box6);
       ...
       box7 = new THREE.Mesh( boxGeometry, boxMaterial);
        box7.position.x = -2;
        box7.position.y = 20;
        box7.position.z = 24;  
        scene.add(box7);    
       ...
       box8 = new THREE.Mesh( boxGeometry, boxMaterial);
        box8.position.x = 10;
        box8.position.y = 20;
        box8.position.z = 24; 
        scene.add(box8);
         ...
         box9 = new THREE.Mesh( boxGeometry, boxMaterial);
        box9.position.x = 22;
        box9.position.y = 20;
        box9.position.z = 24;
        scene.add(box9);

       box10 = new THREE.Mesh( boxGeometry, boxMaterial);
        box10.position.x = -2;
        box10.position.y = 20;
        box10.position.z = 36;
        scene.add(box10);

       box11 = new THREE.Mesh( boxGeometry, boxMaterial);
        box11.position.x = 10;
        box11.position.y = 20;
        box11.position.z = 36;
        scene.add(box11);

       box12 = new THREE.Mesh( boxGeometry, boxMaterial);
        box12.position.x = 22;
        box12.position.y = 20;
        box12.position.z = 36;
        scene.add(box12);
         ...
         box13 = new THREE.Mesh( boxGeometry, boxMaterial);
        box13.position.x = -14;
        box13.position.y = 20;
        box13.position.z = 36;
        scene.add(box13);
        
        box14 = new THREE.Mesh( boxGeometry, boxMaterial);
        box14.position.x = -14;
        box14.position.y = 20;
        box14.position.z = 24;
        scene.add(box14);

      box15 = new THREE.Mesh( boxGeometry, boxMaterial);
        box15.position.x = -14;
        box15.position.y = 20;
        box15.position.z = 12;
        scene.add(box15);

        box16 = new THREE.Mesh( boxGeometry, boxMaterial);
        box16.position.x = -14;
        box16.position.y = 20;
        box16.position.z = -2;
        scene.add(box16);
